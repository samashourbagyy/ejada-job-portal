...
-- Create trigger
CREATE OR REPLACE TRIGGER USER_SKILLS_TRG
BEFORE INSERT ON USER_SKILLS
FOR EACH ROW
BEGIN
    IF :NEW.USER_SKILL_ID IS NULL THEN
        SELECT USER_SKILLS_SEQ.NEXTVAL
        INTO :NEW.USER_SKILL_ID
        FROM DUAL;
    END IF;
END;
/
...
-- Create trigger
CREATE OR REPLACE TRIGGER OPPORTUNITY_SKILLS_TRG
BEFORE INSERT ON OPPORTUNITY_SKILLS
FOR EACH ROW
BEGIN
    IF :NEW.OPPORTUNITY_SKILL_ID IS NULL THEN
        SELECT OPPORTUNITY_SKILLS_SEQ.NEXTVAL
        INTO :NEW.OPPORTUNITY_SKILL_ID
        FROM DUAL;
    END IF;
END;
